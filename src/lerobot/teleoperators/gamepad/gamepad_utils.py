...
class InputController:
    ...
    def __init__(self, x_step_size=1.0, y_step_size=1.0, z_step_size=1.0):
        ...
        """
        print("InputController init called.")
...
class GamepadControllerHID(InputController):
    ...
    def __init__(
        ...
        """
        print("in GamepadControllerHID, about to call super().__init__ which is InputController")
        super().__init__(x_step_size, y_step_size, z_step_size)
        self.deadzone = deadzone
        self.device = None
    ...
    def find_device(self):
        ...
        for device in devices:
            ...
            if any(manufacturer in manufacturer_name for manufacturer in ["Sony"]):
                return device
    ...
    def start(self):
        ...
        print("start called in GamepadControllerHID")
        import hid
