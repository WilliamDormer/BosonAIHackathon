...
class SO101Follower(Robot):
    ...
    def send_action(self, action: dict[str, Any]) -> dict[str, Any]:
        ...
        '''
        This is what the action is giving. (aka ee space)
        {'delta_x': np.float32(-0.0), 'delta_y': np.float32(-0.0), 'delta_z': np.float32(-0.0), 'gripper': 1}

        But this is what it expects: (aka joint space)
        {
        ...
        # action = {
        #     "shoulder_lift.pos" : present_pos['shoulder_lift'] + action_scale * action['delta_z'],
        #     "shoulder_pan.pos" : present_pos['shoulder_pan'] + action_scale * action['delta_x'],
        #     "wrist_roll.pos" : present_pos['wrist_roll'] + action_scale * action['delta_y']
        # }
